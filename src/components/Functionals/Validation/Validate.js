export default function validate(input) {
  ...
  /////////////////
    ...
    errors.height = "It's required a height of format 'Hmin-Hmax'";
  } else if (Number(input.height.split("-")[0]) > Number(input.height.split("-")[1])) {
  ...
  ////////////////////
    ...
    errors.weight = "It's required a weight of format 'Wmin-Wmax'.";
  } else if (Number(input.weight.split("-")[0]) > Number(input.weight.split("-")[1])) {
  ...
  ////////////////////
    ...
    errors.life_span = "It's required a life span of format 'Vmin-Vmax'";
  } else if (Number(input.life_span.split("-")[0]) > Number(input.life_span.split("-")[1])) {
    errors.life_span = "The maximum life span must be higher than the minimum life span";
